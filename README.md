🏷️ Auto Tagger Plugin for Eagle
...
1. 获取模型
请访问 HuggingFace - SmilingWolf 下载以下推荐模型（下载 model.onnx 和 selected_tags.csv 两个文件即可(CL-Tagger除外)）：
...
注：cL-tagger模型文件夹下放置的是model.onnx和tag_mapping.json
